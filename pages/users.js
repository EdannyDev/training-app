...
const UserManagement = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      setLoading(true);
      try {
        const response = await axios.get('https://backend-training-nni3.onrender.com/api/users/list', {
  ...
  const handleDelete = () => {
    ...
    setLoading(true);
    axios
      .delete(`https://backend-training-nni3.onrender.com/api/users/delete/${userToDelete}`, {
