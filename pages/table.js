...
const TrainingTable = () => {
  ...
  const fetchTrainings = async () => {
    setLoading(true);
    try {
      const { data } = await axios.get('https://backend-training-nni3.onrender.com/api/trainings', {
  ...
  const handleDelete = async () => {
    ...
    try {
      setLoading(true);
      await axios.delete(`https://backend-training-nni3.onrender.com/api/trainings/${selectedTraining._id}`, {
